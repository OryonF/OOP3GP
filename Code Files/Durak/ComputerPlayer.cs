public class ComputerPlayer : Player
{
    ...
    public Card MakeMove(bool isAttack, List<Card> currentRoundAttacks, Card lastPlayedCard, string trumpSuit)
    {
        ...
        if (isAttack && currentRoundAttacks.Count > 0)
        {
            ...
            {
                if (Card.CanAdditionalAttack(c, currentRoundAttacks))
                {
                    possible.Add(c);
                }
            }
